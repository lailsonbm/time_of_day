...
<code>2000-01-01 10:00</code> and <code>2000-01-01 10:10</code>. To accomplish what you were trying, you have two alternatives:
...
Copyright (c) 2010 Lailson Bandeira (lailson@guava.com.br). See LICENSE for details.
